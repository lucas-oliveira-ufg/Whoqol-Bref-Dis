<?php
    ...
    $id = $_GET['id_usuario'];
		...
		$consulta = "SELECT id_usuario, nome, email, senha, nivel_acesso FROM cadastro WHERE id_usuario = '$id'";
    ...
    $nome = $questoes['nome'];
		$email = $questoes['email'];
		$senha = $questoes['senha'];
		$nivel = $questoes['nivel_acesso'];
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8 order-md-1">
          ...
          <form method="post" action="update_dados.php" class="needs-validation" novalidate>

            <div class="mb-3">
              <label for="username">Nome do Usuário</label>
              <div class="input-group">
                <input type="text" class="form-control" id="username" name="nome_usuario" value="<?php echo "$nome"; ?>" required>
								<input hidden type="text" class="form-control" id="username" name="id_usuario" value="<?php echo "$id"; ?>" required>
            ...
            <div class="mb-3">
              ...
              <input type="email" class="form-control" id="email" name="email_usuario" value="<?php echo "$email"; ?>">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="email" name="senha_usuario" value="<?php echo "$senha"; ?>">
              <div class="invalid-feedback">
                Please enter a valid email address for shipping updates.
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control" id="address" name="nivel" value="<?php echo "$nivel"; ?>" required>
              <div class="invalid-feedback">
                Please enter your shipping address.
              </div>
            </div>
            <button align='center' type='submit' class='btn btn-primary'>Salvar</button>
						<button align='center' class='btn btn-primary' onclick="window.location.href:'administrador.php'">Cancelar</button>
          </form>
